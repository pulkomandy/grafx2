...
T_Key_config ConfigKey[NB_SHORTCUTS] = {
  ...
  "normal mode.",
  true,
  K2K(SDLK_UP)|MOD_SHIFT, // Shift + Haut
  0},
  {5,
  "Faster scroll down",
  ...
  "normal mode.",
  true,
  K2K(SDLK_DOWN)|MOD_SHIFT, // Shift + Bas
  0},
  {6,
  "Faster scroll left",
  ...
  "normal mode.",
  true,
  K2K(SDLK_LEFT)|MOD_SHIFT, // Shift + Gauche
  0},
  {7,
  "Faster scroll right",
  ...
  "normal mode.",
  true,
  K2K(SDLK_RIGHT)|MOD_SHIFT, // Shift + Droite
  0},
  {8,
  "Slower scroll up",
  "Used to scroll upwards in the",
  ...
  "magnify and normal mode.",
  true,
  K2K(SDLK_LEFT)|MOD_ALT, // Alt + Gauche
  0},
  {11,
  "Slower scroll right",
  "Used to scroll to the right in the",
  ...
  "magnify and normal mode.",
  true,
  K2K(SDLK_RIGHT)|MOD_ALT, // Alt + Droite
  0},
  {12,
  ...
  true,
  K2K(SDLK_UP)|MOD_CTRL, // Ctrl + Haut
  0},
  {13,
  ...
  "when you want ultra-high precision.",
  true,
  K2K(SDLK_DOWN)|MOD_CTRL, // Ctrl + Bas
  0},
  {14,
  ...
  "when you want ultra-high precision.",
  true,
  K2K(SDLK_LEFT)|MOD_CTRL, // Ctrl + Gauche
  0},
  {15,
  ...
  "when you want ultra-high precision.",
  true,
  K2K(SDLK_RIGHT)|MOD_CTRL, // Ctrl + Droite
  0},
  {16,
  ...
  "when you want ultra-high precision.",
  true,
  K2K(SDLK_SPACE)|MOD_CTRL, // Ctrl + Space
  0},
  {17,
  ...
  "when you want ultra-high precision.",
  true,
  K2K(SDLK_SPACE)|MOD_SHIFT, // Shift + Space
  0},
  {18,
  ...
  true,
  K2K(SDLK_F4)|MOD_SHIFT, // Shift + F4
  0},
  {23,
  "Freehand drawing",
  ...
  "",
  true,
  K2K(SDLK_c)|MOD_SHIFT|MOD_CTRL, // Shift + Ctrl + C
  0},
  {39,
  "Empty polygon",
  ...
  "",
  true,
  K2K(SDLK_n)|MOD_SHIFT|MOD_CTRL, // Shift + Ctrl + N
  0},
  {43,
  ...
  "",
  true,
  K2K(SDLK_c)|MOD_SHIFT|MOD_ALT, // Shift + Alt + C
  0},
  {47,
  "Adjust picture",
  ...
  "",
  true,
  K2K(SDLK_KP_5)|MOD_SHIFT, // Shift + Kpad5
  0},
  {49,
  "Drawing effects",
  ...
  "",
  true,
  K2K(SDLK_F5)|MOD_SHIFT, // Shift + F5
  0},
  {131,
  "Quick-shade mode",
  ...
  "",
  true,
  K2K(SDLK_F5)|MOD_SHIFT|MOD_CTRL, // Shift + Ctrl + F5
  0},
  {52,
  "Stencil mode",
  ...
  "",
  true,
  K2K(SDLK_F6)|MOD_SHIFT, // Shift + F6
  0},
  {54,
  "Mask mode",
  ...
  "",
  true,
  K2K(SDLK_F6)|MOD_SHIFT|MOD_ALT, // Shift + Alt + F6
  0},
  {56,
  "Grid mode",
  ...
  "",
  true,
  K2K(SDLK_g)|MOD_SHIFT|MOD_CTRL, // Shift + Ctrl + G
  0},
  {60,
  "Invert sieve",
  ...
  "",
  true,
  K2K(SDLK_g)|MOD_CTRL|MOD_ALT, // Ctrl + Alt + G
  0},
  {61,
  "Colorize mode",
  ...
  "mode.",
  true,
  K2K(SDLK_F7)|MOD_SHIFT, // Shift + F7
  0},
  {63,
  "Smooth mode",
  ...
  "",
  true,
  K2K(SDLK_F8)|MOD_SHIFT, // Shift + F8
  0},
  {64,
  "Smear mode",
  ...
  "",
  true,
  K2K(SDLK_b)|MOD_SHIFT|MOD_ALT, // Shift + Alt + B
  0},
  {206,
  "Tilemap mode",
  ...
  K2K(SDLK_c)|MOD_META // Right-Amiga + C
  #else
  0
  #endif
  },
  ...
  true,
  KEY_NONE, // Set_config_defaults() sets it to SDL_SCANCODE_GRAVE
  0},
  {82,
  ...
  "",
  true,
  KEY_NONE, // Set_config_defaults() sets it to Shift + SDL_SCANCODE_GRAVE
  0},
  {83,
  "Magnifier mode",
  ...
  "user-defined brush.",
  true,
  K2K(SDLK_b)|MOD_CTRL|MOD_ALT, // Ctrl + Alt + B
  0},
  {88,
  "Text",
  ...
  false,
  K2K(SDLK_RETURN)|MOD_SHIFT, // Shift + Enter
  0},
  {91,
  "Help and credits",
  ...
  "",
  true,
  K2K(SDLK_F1)|MOD_SHIFT, // Shift + F1
  0},
  {93,
  "Jump to spare page",
  ...
  "",
  true,
  K2K(SDLK_TAB)|MOD_SHIFT, // Shift + Tab
  0},
  {95,
  "Save picture as...",
  ...
  K2K(SDLK_F2), // F2
  #if defined(__amigaos4__) || defined(__AROS__) || defined(__MORPHOS__) || defined(__amigaos__)
  K2K(SDLK_a)|MOD_META // Right-Amiga + A
  #else
  0
  #endif
  },
  ...
  "",
  true,
  K2K(SDLK_F2)|MOD_SHIFT, // Shift + F2
  #if defined(__amigaos4__) || defined(__AROS__) || defined(__MORPHOS__) || defined(__amigaos__)
  K2K(SDLK_s)|MOD_META // Right-Amiga + S
  #else
  0
  #endif
  },
  ...
  K2K(SDLK_F3), // F3
  #if defined(__amigaos4__) || defined(__AROS__) || defined(__MORPHOS__) || defined(__amigaos__)
  K2K(SDLK_o)|MOD_META // Right-Amiga + O
  #else
  0
  #endif
  },
  ...
  true,
  K2K(SDLK_F3)|MOD_SHIFT, // Shift + F3
  0},
  {99,
  "Save brush",
  "Opens a file-selector that allows",
  ...
  "program.",
  true,
  K2K(SDLK_F10)|MOD_SHIFT, // Shift + F10
  0},
  {102,
  "Undo (Oops!)",
  ...
  K2K(SDLK_z)|MOD_META // Right-Amiga + Z
  #else
  0
  #endif
  // --
  ...
  "list of \"Undo\" pages.",
  true,
  K2K(SDLK_DELETE)|MOD_SHIFT, // Shift + Suppr
  0},
  {104,
  "Clear page",
  ...
  "",
  true,
  K2K(SDLK_BACKSPACE)|MOD_SHIFT, // Shift + BackSpace
  0},
  {106,
  "Quit program",
  ...
  K2K(SDLK_q)|MOD_META // Right-Amiga + Q
  #else
  0
  #endif
  // --
  ...
  "",
  true,
  K2K(SDLK_PAGEUP)|MOD_SHIFT, // Shift + PgUp
  0},
  {111,
  ...
  "",
  true,
  K2K(SDLK_PAGEDOWN)|MOD_SHIFT, // Shift + PgDn
  0},
  {112,
  ...
  "",
  true,
  K2K(SDLK_KP_5)|MOD_CTRL, // Ctrl + 5 (pavé numérique)
  0},
  {113,
  ...
  "corner.",
  true,
  K2K(SDLK_PAGEUP)|MOD_CTRL, // Ctrl + 9
  0},
  {115,
  ...
  "bottom-right corner.",
  true,
  K2K(SDLK_PAGEDOWN)|MOD_CTRL, // Ctrl + 3
  0},
  {117,
  ...
  "",
  true,
  KEY_NONE, // Set_config_defaults() sets it to SDL_SCANCODE_RIGHTBRACKET
  0},
  {118,
  ...
  "",
  true,
  KEY_NONE, // Set_config_defaults() sets it to SDL_SCANCODE_LEFTBRACKET
  0},
  {119,
  ...
  "",
  true,
  KEY_NONE, // Set_config_defaults() sets it to shift + SDL_SCANCODE_RIGHTBRACKET
  0},
  {120,
  ...
  "",
  true,
  KEY_NONE, // Set_config_defaults() sets it to shift + SDL_SCANCODE_LEFTBRACKET
  0},
  {126,
  ...
  "",
  true,
  KEY_NONE, // Set_config_defaults() sets it to SDL_SCANCODE_EQUALS
  0},
  {127,
  ...
  "series.",
  true,
  KEY_NONE, // Set_config_defaults() sets it to SDL_SCANCODE_MINUS
  0},
  {128,
  ...
  "",
  true,
  KEY_NONE, // Set_config_defaults() sets it to shift + SDL_SCANCODE_EQUALS
  0},
  {129,
  ...
  "series.",
  true,
  KEY_NONE, // Set_config_defaults() sets it to shift + SDL_SCANCODE_MINUS
  0},
  {121,
  "Shrink paintbrush",
  ...
  "",
  true,
  KEY_NONE, // Set_config_defaults() sets it to SDL_SCANCODE_PERIOD
  0},
  {122,
  "Enlarge paintbrush",
  ...
  "",
  true,
  KEY_NONE, // Set_config_defaults() sets it to SDL_SCANCODE_SLASH
  0},
  {134,
  "Effects off",
  ...
  "the size ",
  true,
  K2K(SDLK_g)|MOD_SHIFT|MOD_ALT, // Shift + Alt + G,
  0},
  {159,
  "Select layer 1",
  ...
  true,
  K2K(SDLK_INSERT)|MOD_ALT, // Alt + Insert
  0},
  {176,
  "Delete a layer",
  ...
  "layer.",
  true,
  K2K(SDLK_DELETE)|MOD_ALT, // Alt + Delete
  0},
  {177,
  "Merge a layer",
  ...
  "on top.",
  true,
  K2K(SDLK_PAGEUP)|MOD_ALT, // Alt + PageUp
  0},
  {179,
  "Swap layer (down)",
  "Moves the current layer one position",
  ...
  "on bottom.",
  true,
  K2K(SDLK_PAGEDOWN)|MOD_ALT, // Alt + PageDown
  0},
  {180,
  "Layers menu",
  ...
  "",
  true,
  K2K(SDLK_HOME)|MOD_ALT, // Alt + Home
  0},
  {181,
  "Brush factory",
  ...
  true,
  KEY_NONE, // Set_config_defaults() sets it to Control + SDL_SCANCODE_GRAVE
  0},
  {198,
  "Format checker",
